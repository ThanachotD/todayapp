...
const Chats = ({ route, navigation }) => {
    ...
    function handleLoadingData(item,Avatar,username){
        navigation.navigate('Chatprivate',{token:item,AvartarUrl:Avatar,Username:username,users:user});
    }
            ...
            <ScrollView  showsVerticalScrollIndicator={false}
                ...
                <Box>
                    <FlatList  data={freinds} renderItem={({item}) =>
                        <Pressable onPress={()=>handleLoadingData(item.UserToken,item.AvartarUrl,item.Username)} rounded="8" maxW="96" p="1">
